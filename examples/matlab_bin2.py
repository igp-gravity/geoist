...
#data2=sio.loadmat(fname2)
rho10 = data2['data_dens2']
#rho2 = data2['data_dens2']
rho1 = rho10[::6,::10]

maglist = [10.0, 6.0, 2.0, 6.0, 30., 20.0, 40., 4.0]
mag1 = rho1.copy()
...
meshfile = r"d:\msh2.txt"
densfile = r"d:\den2.txt"
magfile = r"d:\mag2.txt"
graoutfile = r"d:\gra2.dat"
magoutfile = r"d:\mag2.dat"
graoutfile1 = r"d:\gra2n.dat"
magoutfile1 = r"d:\mag2n.dat"
area = (-200, 200, -600, 600, 0, 600) #x y z
shape = (100, 120, 1) # z y x
