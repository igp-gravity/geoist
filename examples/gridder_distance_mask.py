...
import pyproj
import numpy as np
import geoist.gridder.coordinates as gg
from geoist.gridder import mask as mk
...
region = gg.get_region((data.longitude, data.latitude))

# Generate the coordinates for a regular grid mask
spacing = 10 / 60
coordinates = gg.grid_coordinates(region, spacing=spacing)
