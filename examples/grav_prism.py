...
"""
Name        : grav_prism.py
 Created on  : 2018/11/30 16:25
 Author      : HL Li <lihonglei@cea-igp.ac.cn>
 ...
 Description : Application for gravity forward.
"""
...
* :func:`~geoiest.gravmag.prism.potential`
* :func:`~geoiest.gravmag.prism.gx`
* :func:`~geoiest.gravmag.prism.gy`
* :func:`~geoiest.gravmag.prism.gz`
* :func:`~geoiest.gravmag.prism.gxx`
* :func:`~geoiest.gravmag.prism.gxy`
* :func:`~geoiest.gravmag.prism.gxz`
* :func:`~geoiest.gravmag.prism.gyy`
* :func:`~geoiest.gravmag.prism.gyz`
* :func:`~geoiest.gravmag.prism.gzz`
...
* :func:`~geoiest.gravmag.prism.tf`
* :func:`~geoiest.gravmag.prism.bx`
* :func:`~geoiest.gravmag.prism.by`
* :func:`~geoiest.gravmag.prism.bz`
...
* :func:`~geoiest.gravmag.prism.kernelxx`
* :func:`~geoiest.gravmag.prism.kernelxy`
* :func:`~geoiest.gravmag.prism.kernelxz`
* :func:`~geoiest.gravmag.prism.kernelyy`
* :func:`~geoiest.gravmag.prism.kernelyz`
* :func:`~geoiest.gravmag.prism.kernelzz`
...
def potential(xp, yp, zp, prisms, dens=None):
    ...
    * prisms : list of :class:`~geoiest.mesher.Prism`
        ...
        :class:`~geoiest.mesher.PrismMesh`.
    * dens : float or None
...
def tf(xp, yp, zp, prisms, inc, dec, pmag=None):
    ...
    * prisms : list of :class:`~geoiest.mesher.Prism`
        ...
        be ignored. *prisms* can also be a :class:`~geoiest.mesher.PrismMesh`.
    * inc : float
...
def kernelxx(xp, yp, zp, prism):
    ...
    * prisms : object of :class:`geoiest.mesher.Prism`
