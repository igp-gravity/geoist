...
* :func:`~geoist.pfm.tensor.invariants`: Calculates the first
  (:math:`I_1`), second (:math:`I_2`), and dimensionless (:math:`I`) invariants
* :func:`~geoist.pfm.tensor.eigen`: Calculates the eigenvalues and
  eigenvectors of an array of gradient tensor measurements
* :func:`~geoist.pfm.tensor.center_of_mass`: Estimate the center of
...
from .. import gridder
from .giutils import safe_solve
