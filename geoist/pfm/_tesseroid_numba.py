...
geoist.pfm.tesseroid as a backend and are not meant to be used directly.
...
from .giconstants import MEAN_EARTH_RADIUS
...
# that will be used by geoist.pfm.tesseroid
