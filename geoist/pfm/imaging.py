...
* :func:`~geoist.pfm.imaging.geninv`: The Generalized Inverse solver in
  the frequency domain (Cribb, 1976)
* :func:`~geoist.pfm.imaging.sandwich`: Sandwich model (Pedersen, 1991).
  Uses depth weighting as in Pilkington (1997)
* :func:`~geoist.pfm.imaging.migrate`: 3D potential field migration
...
from geoist.mesher import PrismMesh
from geoist.pfm import pftrans
from geoist.pfm import prism as pot_prism
from geoist.pfm.giconstants import G
...
def _getdataft(x, y, data, shape):
    ...
    """
    Fx, Fy = pftrans._fftfreqs(x, y, shape, shape)
