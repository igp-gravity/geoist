...
:func:`~geoist.pfm.tesseroid.potential`,
:func:`~geoist.pfm.tesseroid.gx`,
:func:`~geoist.pfm.tesseroid.gy`,
:func:`~geoist.pfm.tesseroid.gz`,
:func:`~geoist.pfm.tesseroid.gxx`,
:func:`~geoist.pfm.tesseroid.gxy`,
:func:`~geoist.pfm.tesseroid.gxz`,
:func:`~geoist.pfm.tesseroid.gyy`,
:func:`~geoist.pfm.tesseroid.gyz`,
:func:`~geoist.pfm.tesseroid.gzz`
...
from .giconstants import SI2MGAL, SI2EOTVOS, MEAN_EARTH_RADIUS, G
...
def potential(lon, lat, height, model, dens=None, ratio=RATIO_V,
    ...
    * lon, lat, height : arrays
        ...
        computation points.
    * model : list of :class:`~geoist.inversion.mesher.Tesseroid`
