...
class Snoopy(object):
    ...
    def __init__(self, anomalies, correlations):
        ...
        :param list anomalies: a list of `Anomaly` objects.
                               `Anomaly` is defined in geoist.snoopy.modules.anomaly.
    ...
    def _analyze_root_causes(self):
        ...
        for a in self.anomalies:
            try:
                ...
                raise exceptions.InvalidDataFormat('geoist.snoopy.geoist.snoopy: dict correlations contains empty list.')
        self.causes = causes
