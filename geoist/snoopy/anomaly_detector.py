...
from geoist.snoopy import exceptions, utils
from geoist.snoopy.algorithms.anomaly_detector_algorithms.all import anomaly_detector_algorithms
from geoist.snoopy.modules.anomaly import Anomaly
from geoist.snoopy.modules.time_series import TimeSeries
from geoist.snoopy.constants import (ANOMALY_DETECTOR_ALGORITHM, ANOMALY_THRESHOLD,
...
class AnomalyDetector(object):
    ...
    def __init__(self, time_series, baseline_time_series=None, score_only=False, score_threshold=None,
        ...
        :param AnomalyDetectorAlgorithm algorithm_class: A AnomalyDetectorAlgorithm class that when passed to geoist.snoopy will
            be used to assign anomaly scores. This is useful when geoist.snoopy user wants to use a custom algorithm.
        """
    ...
    def _get_algorithm(self, algorithm_name):
        ...
        try:
            ...
            raise exceptions.AlgorithmNotFound('geoist.snoopy.AnomalyDetector: ' + str(algorithm_name) + ' not found.')
