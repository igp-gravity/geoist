...
from geoist.snoopy import exceptions
from geoist.snoopy import Snoopy
...
class TestSnoopy(unittest.TestCase):
    def setUp(self):
        ...
        self.Snoopy = Snoopy(self.anomaly, self.correlation)

    def test_get_result(self):
        self.assertTrue(isinstance(self.Snoopy.get_root_causes(), dict))
        self.assertEqual(self.Snoopy.get_root_causes()['A'], 'm1')
        self.assertEqual(self.Snoopy.get_root_causes()['B'], 'm2')
