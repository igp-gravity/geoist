"""
Utilities for using Geoist with sphinx-gallery.
"""
try:
...
class GeoistScraper:  # pylint: disable=too-few-public-methods
    """
    Save ``geoist.Figure`` objects that had their ``show`` method called.
