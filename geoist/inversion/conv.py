...
* :func:`~geoist.inversion.conv.convolutional_model`: given the reflectivity
  series and wavelet, it returns the convolutional seismic gather.
* :func:`~geoist.inversion.conv.reflectivity`: calculates the reflectivity
  series from the velocity model (and density model if present).
* :func:`~geoist.inversion.conv.depth_2_time`: convert depth property model to
  the model in time.
* :func:`~geoist.inversion.conv.rickerwave`: calculates a ricker wavelet.
