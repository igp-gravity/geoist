...
class Vector(BaseGridder):
    ...
    Each data component provided to :meth:`~geoist.gidder.Vector.fit` is fitted to a separated
    estimator. Methods like :meth:`~geoist.gidder.Vector.grid` and :meth:`~geoist.gidder.Vector.predict`
    ...
    region_ : tuple
        ...
        as the default region for the :meth:`~geoist.gidder.Vector.grid` and
        :meth:`~geoist.gidder.Vector.scatter` methods.

    See also
    --------
    geoist.gidder.Chain : Chain filtering operations to fit on each subsequent output.
    ...
    def fit(self, coordinates, data, weights=None):
        ...
        :meth:`~geoist.gidder.Vector.grid` and :meth:`~geoist.gidder.Vector.scatter` methods.
    ...
    def predict(self, coordinates):
        ...
        Requires a fitted estimator (see :meth:`~geoist.gidder.Vector.fit`).
...
class VectorSpline2D(BaseGridder):
    ...
    are set the first time :meth:`~geoist.gidder.VectorSpline2D.fit` is called. Subsequent calls
    ...
    *damping* argument. Alternatively, you can specify the position of the forces
    ...
    force_coords : None or tuple of arrays
        ...
        :meth:`~geoist.gidder.VectorSpline2D.fit` is called.
    engine : str
    ...
    region_ : tuple
        ...
        :meth:`~geoist.gidder.VectorSpline2D.grid` and :meth:`~geoist.gidder.VectorSpline2D.scatter`
        methods.
    ...
    def predict(self, coordinates):
        ...
        Requires a fitted estimator (see :meth:`~geoist.gidder.VectorSpline2D.fit`).
