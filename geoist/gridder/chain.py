...
class Chain(BaseGridder):
    ...
    The :meth:`~geoist.gidder.base.BaseGridder.filter` method of each element of the set is
    ...
    Steps that don't implement a :meth:`~geoist.gidder.base.BaseGridder.predict` method are
    ignored.
    ...
    ----------
    steps : list
        A list of ``('name', step)`` pairs where ``step`` is any geoist.gidder
    ...
    region_ : tuple
        ...
        Used as the default region for the :meth:`~geoist.gidder.Chain.grid` and
        :meth:`~geoist.gidder.Chain.scatter` methods.
    named_steps : dict
    ...
    See also
    --------
    geoist.gidder.Vector : Fit an estimator to each component of multi-component vector data
    ...
    def fit(self, coordinates, data, weights=None):
        ...
        :meth:`~geoist.gidder.Chain.grid` and :meth:`~geoist.gidder.Chain.scatter` methods.
    ...
    def predict(self, coordinates):
        ...
        Requires a fitted gridder (see :meth:`~geoist.gidder.Chain.fit`).
