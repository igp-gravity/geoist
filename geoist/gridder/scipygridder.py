...
class ScipyGridder(BaseGridder):
    ...
    region_ : tuple
        ...
        :meth:`~geoist.gidder.ScipyGridder.grid` and
        :meth:`~geoist.gidder.ScipyGridder.scatter` methods.
    ...
    def fit(self, coordinates, data, weights=None):
        ...
        Returns
        -------
        self : geoist.gidder.ScipyGridder
    ...
    def predict(self, coordinates):
        ...
        Requires a fitted gridder (see :meth:`~geoist.gidder.ScipyGridder.fit`).
