...
class Spline(BaseGridder):
    ...
    :meth:`~geoist.gidder.Spline.fit`. This configuration provides an exact solution on top of
    ...
    force_coords : None or tuple of arrays
        ...
        :meth:`~geoist.gidder.Spline.fit` is called.
    engine : str
    ...
    region_ : tuple
        ...
        :meth:`~geoist.gidder.Spline.grid` and :meth:`~geoist.gidder.Spline.scatter` methods.
    ...
    def predict(self, coordinates):
        ...
        Requires a fitted estimator (see :meth:`~geoist.gidder.Spline.fit`).
