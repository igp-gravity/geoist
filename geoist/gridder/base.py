...
class BaseGridder(BaseEstimator):
    ...
    :meth:`~geoist.gidder.base.BaseGridder.predict` method. The data returned by it should
    be a 1d or 2d numpy array for scalar data or a tuple with 1d or 2d numpy
    arrays for each component of vector data.

    The :meth:`~geoist.gidder.base.BaseGridder.filter` method requires the implementation of
    a :meth:`~geoist.gidder.base.BaseGridder.fit` method to fit the gridder model to data.
    ...
    * Estimated parameters should be stored as attributes with names ending in
    ...
    def filter(self, coordinates, data, weights=None):
        ...
        with other processing operations and is used by :class:`geoist.gidder.Chain` to
    ...
    def grid(
        ...
        *shape*) or by the grid node spacing. See :func:`geoist.gidder.grid_coordinates` for
        details. Other arguments for :func:`geoist.gidder.grid_coordinates` can be passed as
        ...
        See also
        --------
        geoist.gidder.grid_coordinates : Generate the coordinate values for the grid.
    ...
    def scatter(
        ...
        **kwargs
        ...
        Point coordinates are generated by :func:`geoist.gidder.scatter_points`. Other arguments
    ...
    def profile(
        ...
        **kwargs
        ...
        coordinates are generated by :func:`geoist.gidder.profile_coordinates`. Other arguments
        for this function can be passed as extra keyword arguments (``kwargs``) to this
        method.
